...
export const Loto7NumberValidator =
  PositiveIntNumberValidator.min(1).max(MAX_LOTO7_NUMBER);
export const Loto7MainNumbersValidator = z
  .array(Loto7NumberValidator)
  .length(7);
export const Loto7BonusNumbersValidator = z
  .array(Loto7NumberValidator)
  .length(2);
