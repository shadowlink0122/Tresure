...
async function execSearchAllNumberAppearence(params: SearchAllNumberAppearenceRequestParams): Promise<SearchAllNumberAppearenceResponse> {
  ...
  return responseHandler<SearchAllNumberAppearenceResponse>(response, '/api/search/loto7/appearence');
}

export {
  execSearchAllNumberAppearence
}
