...
async function execPredictResultGetRequest(
  params: string | undefined,
): Promise<PredictResultGetResponse> {
  let queryParams = '';
  ...
  return responseHandler<PredictResultGetResponse>(
    response,
    `/api/predict/loto7/result?${queryParams}`,
  );
}

export { execPredictResultGetRequest };
